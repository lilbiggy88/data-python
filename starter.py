...
if hair_color == 'Brown':
    print('My hair is brown!')
else:
    print('My hair is not brown!')
...
colors = ['blue', 'green', 'yellow', 'brown', 'orange']
...
for element in numbers:
    print(element)
    # numbers.forEach(line => console.log(line))
...
# Problem 12
# Research to find the Python method that allows you to add an element to the end of the array (similar to push() 
# in JavaScript), then add a name to the end of the `friends` array.

friends.append('John')
print(friends)

# Problem 13
# Print out the total amount of elements in the `friends` array. The Python method you are looking for is similar to 
# the JavaScript property `.length`.

print("Total amount of elements:",len(friends))
...
friends.insert(2, "Amanda")
print(friends)

# Problem 15
# Remove the last item in the array (try to think about how you can do this dynamically, meaning, if the array contents were 
# to change, your code would still work).
